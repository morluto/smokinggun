# SmokingGun release-integrity report

Audit date: 2026-08-05.

## Package contract

The package manifest is smokinggun@1.0.0. It exposes one executable, smokinggun, and
...
present at `skills/smokinggun/SKILL.md`, and no agent directory was created during
npm installation.
...
SmokingGun does not modify agent configuration or silently install packages.
